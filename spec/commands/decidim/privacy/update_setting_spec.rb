    ...
    describe UpdateSetting do
      ...
      context "when user updates the settings" do
        ...
        it "creates a setting" do
          expect do
            subject.call
          end.to change(::Decidim::Privacy::Setting, :count).by(2) # Organization && User Setting
        end
        ...
        it "updates a setting" do
          ...
          subject.call
          r = ::Decidim::Privacy::Setting.find_by(user: user, organization: current_organization)
